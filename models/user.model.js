...
exports.UserErrorResponse = exports.UserResponse = exports.UserResponseModel = exports.UserModel = exports.CreateUserRequest = exports.AuthProvider = void 0;
...
__decorate([
    (0, swagger_express_ts_1.ApiModelProperty)({
        enum: [AuthProvider.LOCAL, AuthProvider.FACEBOOK, AuthProvider.GOOGLE],
    }),
    (0, validation_1.Constraint)(joi.allow('')),
    __metadata("design:type", String)
